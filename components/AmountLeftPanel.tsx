  ...
  return (
    <div className="bg-green-50 dark:bg-green-900/20 rounded-2xl p-4 md:p-6 shadow-card hover:shadow-xl transition-all duration-300 hover:scale-[1.02] border border-green-200 dark:border-green-700">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="p-4 bg-gradient-to-br from-lavender-100 to-purple-100 dark:from-purple-900/20 dark:to-violet-900/20 rounded-xl border border-lavender-300 dark:border-purple-800">
        ...
        <div className="p-4 bg-gradient-to-br from-red-100 to-orange-100 dark:from-red-900/20 dark:to-orange-900/20 rounded-xl border border-red-300 dark:border-red-800">
      ...
      {/* Daily Budget */}
      <div className="p-4 bg-gradient-to-r from-emerald-100 to-teal-100 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-xl border-2 border-emerald-300 dark:border-emerald-700">
